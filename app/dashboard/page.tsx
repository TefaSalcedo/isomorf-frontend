...
function DashboardContent() {
  ...
  async function createProject(event: React.FormEvent<HTMLFormElement>) {
    ...
    try { const project = await api.createProject({ name: String(data.name), description: String(data.description) }); router.push(`/projects/${project.id}`); }
